  ...
  class Trx_Ganti extends CI_controller{
    ...
    function save_data_input_denom()
    {
      if ($this->input->post()) {
        ...
        $qty_75000 =  $this->input->post('qty_75000') != '' ? $this->input->post('qty_75000') : 0;
        ...
        $result = $this->Mod_cdc_trx_detail_pengganti->save_data_input_denom($det_id,$rec_id,$no_shift,$qty_100000,$qty_75000,$qty_50000,$qty_20000,$qty_10000,$qty_5000,$qty_2000,$qty_1000,$qty_500,$qty_200,$qty_100,$qty_50,$qty_25);
        echo $result;
      }
    }
