    ...
    public function  get_data_shift_per_tanggal($sales_date,$store_code){
      $statement = 'select *
                    from
                      (
                      select
		                    SUM(case when asd."SHIFT" = \'1\' AND ( select
		                    	cdspd."SALES_AMOUNT"
		                    from
		                    ...
		                    where
		                    	...
		                    	and cdspd."SHIFT" = \'1\') != 0 then 1 else 0 end) "SHIFT_1",
		                    ...
		                    where
		                    	cdspd."SALES_DATE" = ?
		                    	and cdspd."STORE_CODE" = ?
		                    	and cdspd."SHIFT" = \'2\') != 0 then 1 else 0 end) "SHIFT_2",
		                    ...
		                    where
		                    	cdspd."SALES_DATE" = ?
		                    	and cdspd."STORE_CODE" = ?
		                    	and cdspd."SHIFT" = \'3\') != 0 then 1 else 0 end) "SHIFT_3"
                      from
                        (
                        select
                          cdspd."SHIFT"
      ...
      $result = $this->db->query($statement,array($sales_date,$store_code,$sales_date,$store_code,$sales_date,$store_code,$sales_date,$store_code))->result();
