<?php
  class Mod_cdc_trx_detail_pengganti extends CI_Model{
    ...
    function get_data_denom_sd7($store,$salesDate,$tipe_shift)
    {
      ...
      $statement='SELECT "25" as "25_RP","50" as "50_RP","100" as "100_RP","200" as "200_RP","500" as "500_RP","1000" as "1000_RP","2000" as "2000_RP","5000" as "5000_RP","10000" as "10000_RP","20000" as "20000_RP","50000" as "50000_RP","100000" as "100000_RP"
    ...
    function save_data_input_denom($det_id,$rec_id,$no_shift,$qty_100000,$qty_50000,$qty_20000,$qty_10000,$qty_5000,$qty_2000,$qty_1000,$qty_500,$qty_200,$qty_100,$qty_50,$qty_25)
    {
        ...
        if($det_id == 'X'){
            ...
            $statement='INSERT INTO cdc_trx_receipts_denom(
                                ...
                                "2000", "5000", "10000", "20000", "50000", "100000", "CREATION_DATE", 
                                "LAST_UPDATE_DATE")
                        VALUES (?, ?, ?, ?, ?, ?, ?, 
                                ?, ?, ?, ?, ?, ?, CURRENT_DATE, 
                                CURRENT_DATE)';
            $this->db->query($statement, array($rec_id,$qty_25,$qty_50,$qty_100,$qty_200,$qty_500,$qty_1000,$qty_2000,$qty_5000,$qty_10000,$qty_20000,$qty_50000,$qty_100000));
            return $this->db->affected_rows();
        }
        else{
          ...
          if($res_cek->HITUNG=='0')
          {
            ...
            $this->db->query($statement,array($qty_25,$qty_50,$qty_100,$qty_200,$qty_500,$qty_1000,$qty_2000,$qty_5000,$qty_10000,$qty_20000,$qty_50000,$qty_100000,$det_id,$rec_id));
          }
