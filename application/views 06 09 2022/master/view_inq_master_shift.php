    ...
    <div align="left" style="padding:5px; margin-left:15px">
      <table>
        <tr>
          ...
          <td colspan="2">
              <input id="store_code" type="text" class="easyui-combobox" data-options="valueField:'STORE_CODE',textField:'STORE',url:'<?php echo base_url(); ?>master/Shift/get_kode_toko'" style="width:340px;">
          </td>
          ...
          <td>
            <select class="easyui-combobox" name="metode_setor" id="metode_setor" style="width:150px">
                 <option value=""></option>
              <option value="PIHAK3">Pihak ke 3 (STN)</option>
              <option value="KODEL">Kodel (STJ)</option>

              <option value="BANK">Setoran Bank (STN)</option>
        ...
        <tr>
          ...
          <td>
            <input class="easyui-datebox" name="start_date" id="start_date"  style="width:160px;"> &nbsp &nbsp
          </td>
          <td><input class="easyui-datebox" name="end_date" id="end_date"  style="width:160px;"> &nbsp &nbsp</td>
          <td style="width:50px"> &nbsp </td>
             <td>
            Tipe Shift :
          </td>
        ...
        <tr>
         <!--   <td>
          ...
          <td>
            <select class="easyui-combobox" name="jml_shift" id="jml_shift" style="width:160px">
              <option value=""></option>
      ...
      <table id="tblShift" title="Master Shift Toko" class="easyui-datagrid" style="width:100%;height:auto"
        ...
        <thead>
          <tr>
            ...
            <th data-options="field:'TGL_ACTIVE',width:100, align:'center',formatter:formatDate1" >TGL AKTIF SHIFT</th>
            <th data-options="field:'TGL_INACTIVE',width:100, align:'center',formatter:formatDate1">TGL BERAKHIR SHIFT</th>
      ...
      <table id="temporary_store" title="Master Shift Toko Temp" class="easyui-datagrid" style="width:100%;height:auto"
        ...
        <thead>
          <tr>
            ...
            <th data-options="field:'ACTIVE_DATE',width:100,align:'center',formatter:formatDate1">TGL AKTIF SHIFT</th>
            <th data-options="field:'END_DATE',width:100,align:'center',formatter:formatDate1">TGL BERAKHIR SHIFT</th>
...
<div id="edit_new_store" class="easyui-window" title="Edit New Store" style="width:900;height:250; padding:10px;"
  ...
  <form id="form_edit_master_shift" enctype="multipart/form-data">
    ...
    <table align="center">
     ...
     <tr>
          ...
          <td>
            <input class="easyui-datebox" name="e_start_date" id="e_start_date" disabled="true"> &nbsp &nbsp
          </td>
        ...
        <td>
          ...
          <td>
            <select class="easyui-combobox" name="e_jml_shift" id="e_jml_shift" style="width:150px" disabled="true">
              <option value="0">0</option>
              <option value="1">1</option>
              <option value="2">2</option>
              <option value="3">3</option>
            ...
            <input id="e_id_shift" type="hidden"  style="width:330px;">
 ...
 <td colspan="4"></td>
        ...
        <td colspan="2">
           ...
           <a href="#" id='BtnDelForm' class="easyui-linkbutton" onclick="saveEMasterShift()" style="width:100px">Save </a>
          </td> 
