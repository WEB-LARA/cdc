...
<div DATA-OPTIONS="region:'center'" style="height:90%;">
  ...
  <script type="text/javascript" src="<?php echo base_url();?>assets/js/inputBatch.js?3"></script>
  ...
  <div id="atas" class="easyui-panel" title="Receipt Batch" style="padding:0px; position:static;width:100%;height:28%;" data-options="iconCls: 'icon-add'">
    <div align="right" style="padding:5px; margin-right:2%">
      &nbsp <input type="checkbox" id="sales_flag" name="salesFlag" value="1" tabindex="-1" checked> Sales Flag
    ...
    <div id="topInput">
      <table align="center" border="0">
        ...
        <tr>
          ...
          <td>
             <input id="flagshift" name="FLAG_SHIFT" class="easyui-combobox" data-options="valueField:'SHIFT',textField:'SHIFT_DESC'"  style="min-width: 100px; min-height:25px;" required >
           <!--   <input class="easyui-combobox" id="flagshift" name="FLAG_SHIFT" data-options="valueField:'SHIFT',textField:'SHIFT_DESC',url:'<?php echo base_url('inputBatch/get_tipe_shift'); ?>', onSelect: function(rec){
        ...
        $('#dc-user').combobox('setValue', '');
          ...
          <td>
            <a href="#" id="btnSave" class="easyui-linkbutton" onclick="receiptSaveShift()" data-options="iconCls:'icon-save'"><u>S</u>ave</a>
