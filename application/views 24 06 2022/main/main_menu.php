...
<div id="rep_monitoring_absensi_denom_toko_idm" class="easyui-window" title="Report Absensi Pengiriman Input-an Sales per Denom Toko Idm" style="width:480px;height:270px; padding:10px;"
            data-options="iconCls:'icon-script',modal:true,collapsible:false,minimizable:false,maximizable:false">
    <table align="center">
      <tr>
        <td style="min-width: 115px!important;">Cabang</td>
