...
<div DATA-OPTIONS="region:'center'" style="height:90%;">
  ...
  <script type="text/javascript" src="<?php echo base_url();?>assets/js/inputBatchDenom.js?3"></script>
  
  <?php echo $this->session->flashdata('form_shift'); ?>
  
  <?php echo $this->session->flashdata('data_batch_reject'); ?>

  <div id="atas" class="easyui-panel" title="Receipt Batch DENOM" style="padding:0px; position:static;width:100%;height:28%;" data-options="iconCls: 'icon-add'">
    <div align="right" style="padding:5px; margin-right:2%">
      &nbsp <input type="checkbox" id="sales_flag" name="salesFlag" value="1" tabindex="-1" checked disabled="true"> Sales Flag
      &nbsp <input type="hidden" id="CDC_REC_ID1">
      &nbsp <input type="hidden" id="CDC_REC_ID2">
      &nbsp <input type="hidden" id="CDC_REC_ID3">
      &nbsp <input type="hidden" id="CDC_REC_REAL_ID">
      &nbsp <input type="hidden" id="CDC_REC_ID_SHIFT">
      &nbsp <input type="checkbox" id="stnFlag" name="stnFlag" value="0" onclick="" tabindex="-1" disabled="true"> STN
      &nbsp 
<!-- onclick="flag(this)"-->
      <b> &nbsp
        ...
        <tr>
          ...
          <input 
            ...
            <input 
              type="hidden" 
              id="role-id" 
              value="<?php echo $this->session->userdata('role_id'); ?>"
            >
          ...
          <td>
            <input 
              id="tglSales" type="text" name="TGL_BATCH" 
              class="easyui-datebox" style="width:100px; height:25px;" 
              tabindex="-1" 
            > &nbsp
          </td>
          <td>
            <input 
              ...
              data-options="valueField:'SHIFT',textField:'SHIFT_DESC'"  
              style="min-width: 100px; min-height:25px;" required disabled
            >
          </td>

          <td>
            <input id="cashPenggantian" type="text" name="CHASH" class="easyui-numberbox" style="width:120px; height:25px;" tabindex="2" data-options="min:0,groupSeparator:','" > &nbsp
          </td>
          <td>
            <input id="totalPenambah" type="text" name="PENAMBAH" class="easyui-numberbox" style="width:120px; height:25px;" tabindex="3" data-options="min:0,groupSeparator:','" readonly> &nbsp
          </td>
          <td>
            <input id="totalPengurang" type="text" name="PENGURANG" class="easyui-numberbox" style="width:120px; height:25px;" tabindex="4" data-options="min:0,groupSeparator:','" readonly> &nbsp
          </td>
          <td>
            <input id="totalVoucher" type="text" name="VOUCHER" class="easyui-numberbox" style="width:120px; height:25px;" tabindex="5" data-options="groupSeparator:','" readonly> &nbsp
...
<div id="buttonSubmit" align="left" style="	margin-left:5px; padding:5px;">
  ...
  <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" id="genBatch" onclick="btnGenerateShift()" style="width:200px;padding:10px;">Generate <u>B</u>atch</a>
