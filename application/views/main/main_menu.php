...
<body class="easyui-layout" background="<?php echo base_url();?>assets/image/wall_login.jpg">
  <div DATA-OPTIONS="region:'north'" style="height:55px; no-repeat;">
      ...
      //IF PUNYA SUBMENU
      if(trim($row->DETAILED_DATA) === "Y"){
        echo " <div id='".$row->MENU_ID."' style='width:560px;'> ";
...
<div id="upload_data_am_as" class="easyui-window" title="Upload Data AM dan AS" style="width:360px;height:150px; padding:10px;"
 ...
 <div id="information" class="easyui-dialog" title="Pengumuman Penambahan Kolom File Upload STN " data-options="iconCls:'icon-save'" style="width:400px;height:300px;padding:10px">
    <div>
      
      <p>Per Tanggal <b>19 Januari 2021</b>, ada penambahan kolom di file Upload STN yakni (TIPE_SHIFT).</p>
      <p>Tipe Shift ini <b>harus</b> diisi di setiap baris di file.</p>
      <p>Jenis Tipe Shift yang bisa diisi hanya <b>HARIAN,SS1,SS2,SS3</b>.</p>
      <p> 1.   HARIAN : Untuk Sales yg diterima 1 hari full</p>
      <p> 2.   SS1,SS2,SS3: Untuk Sales yg diterima <b>Parsial</b></p>
      <p> Terimakasih</p>
    </div>
...
<div id="rep_monitoring_kurang_setor" class="easyui-window" title="Laporan Monitoring Kurang Setor Fisik Sales IDM" style="width:400;height:270px; padding:10px;"
            data-options="iconCls:'icon-script',modal:true,collapsible:false,minimizable:false,maximizable:false">
    <table align="center">
      <tr>
        <td style="min-width: 115px!important;">Cabang</td>
        <td style="min-width: 135px!important;">
            ...
            <input id="mks_branch" type="text" class="easyui-combobox" data-options="valueField:'BRANCH_ID',textField:'BRANCH_VALUE',url:'<?php echo base_url(); ?>Report/choose_branch?>'" style="width:135px; height:30px;">
        </td>
      </tr>
      <tr>
        ...
        <td style="min-width: 135px!important;">
            ...
            <input id="mks_kode_toko" type="text" class="easyui-combobox" data-options="valueField:'STORE_CODE',textField:'STORE'" style="width:135px; height:30px;">
        </td>
      </tr>
      <tr>
        <td style="min-width: 115px!important;">Status Setor</td>
        <td style="min-width: 135px!important;">
          <select id="status_setor_mks" class="easyui-combobox" name="" style="width: 135px; min-height:30px;">
            <option value="A">All</option>
            <option value="M">Match</option>
            <option value="S">Selisih</option>
            <option value="S1">Selisih > 1000</option>
          </select>
        </td>
      </tr>
      <tr>
        <td style="min-width: 115px!important;">Tipe Setoran</td>
        <td style="min-width: 135px!important;">
          <select id="tipe_setor_mks" class="easyui-combobox" name="" style="width: 135px; min-height:30px;">
      ...
      <tr>
        <td style="min-width: 115px!important;">Periode</td>
        <td style="min-width: 135px!important;">
          <input name="periode_mks" id="periode_mks" class="easyui-datetimespinner" style="width:100%;">
        </td>
      </tr>
      <!-- <tr>
        <td style="min-width: 115px!important;">Report Type</td>
        <td style="min-width: 135px!important;">
          <select id="report_type_mks" class="easyui-combobox" name="" style="width: 135px; min-height:30px;">
      ...
      <tr>
        ...
        <td align="right">
          <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" id="sub_mks_pdf" style="min-width:133px !important;min-height:30px !important;">PDF</a>
        </td>
      
        <td align="right">
          <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" id="sub_mks_csv" style="min-width:133px !important;min-height:30px !important;">CSV</a>
        </td>
      </tr>
    </table>
</div>

<div id="rep_monitoring_absensi_denom_toko_idm" class="easyui-window" title="Report Absensi Pengiriman Input-an Sales per Denom Toko Idm" style="width:580px;height:270px; padding:10px;"
            data-options="iconCls:'icon-script',modal:true,collapsible:false,minimizable:false,maximizable:false">
    <table align="center">
      <tr>
        <td style="min-width: 115px!important;">Cabang</td>
        <td style="min-width: 135px!important;">
            ...
            <input id="adt_branch" type="text" class="easyui-combobox" data-options="valueField:'BRANCH_ID',textField:'BRANCH_VALUE',url:'<?php echo base_url(); ?>Report/choose_branch?>'" style="width:135px; height:30px;">
        </td>
      </tr>
      <tr>
        <td style="min-width: 115px!important;">Kode Toko</td>
        <td style="min-width: 135px!important;">
            ...
            <input id="adt_kode_toko" type="text" class="easyui-combobox" data-options="valueField:'STORE_CODE',textField:'STORE'" style="width:135px; height:30px;">
        </td>
      </tr>
      <!-- <tr>
        <td style="min-width: 115px!important;">Status Setor</td>
        <td style="min-width: 135px!important;">
          <select id="status_setor_mks" class="easyui-combobox" name="" style="width: 135px; min-height:30px;">
            ...
            <option value="M">Match</option>
            <option value="S">Selisih</option>
            <option value="S1">Selisih > 100</option>
          </select>
        </td>
      </tr> -->
      <tr>
        <td style="min-width: 115px!important;">Periode</td>
        <td style="min-width: 135px!important;">
        <input name="periode_adt" id="periode_adt" class="easyui-datetimespinner" style="width:100%;">
        </td>
      </tr>
      <!-- <tr>
        <td style="min-width: 115px!important;">Report Type</td>
      ...
      <tr>
        ...
        <td align="right">
          <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" id="sub_adt_pdf" style="min-width:133px !important;min-height:30px !important;">PDF</a>
        </td>
      
        <td align="right">
          <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" id="sub_adt_csv" style="min-width:133px !important;min-height:30px !important;">CSV</a>
        </td>
      </tr>
    </table>
</div>
...
<div id="req_receipt_register" class="easyui-window" title="Receipt Register**" style="width:410px;height:300px; padding:10px;"
    ...
    <table align="center" border="0">
      <tr>
        <td style="min-width: 100px!important;">Cabang</td>
        <td style="min-width: 150px!important;">
          <select id="receipt_register_branch" class="easyui-combobox" name="" style="width: 210px; min-height:30px;" <?php if ($this->session->userdata('role_id') < 5) {?> branch-id="<?php echo $this->session->userdata('branch_id'); ?>" disabled <?php } ?> required>
          </select>
        </td>
      </tr>
      <tr>
        <td style="min-width: 100px!important;">Kode Gudang</td>
        <td style="min-width: 150px!important;">
          <select id="receipt_register_dc_code" class="easyui-combobox" name="" style="width: 210px; min-height:30px;" <?php if ($this->session->userdata('role_id') < 3) {?> dc-code="<?php echo $this->session->userdata('dc_code'); ?>" disabled <?php } ?> required>
          </select>
        </td>
      </tr>
      <tr>
        <td> Tanggal Awal </td>
        <td>
          <select class="easyui-datebox" name="batch_number" id="date1_receipt_register" style="width:210px; height:30px;" required>
        </td>
      </tr>
      <tr>
        <td> Tanggal Berakhir </td>
          <td>
            <select class="easyui-datebox" name="batch_number" id="date2_receipt_register" style="width:210px; height:30px;" required>
          </td>
      </tr>
      <tr>
        <td style="min-width: 70px!important;"> Store Code Begin </td>
        <td>
          <select class="easyui-combobox" name="batch_number" id="combo1_receipt_register" style="width:210px; height:30px;" required>
        </td>
      </tr>
      <tr>
        <td style="min-width: 70px!important;"> Store Code End </td>
        <td>
          <select class="easyui-combobox" name="batch_number" id="combo2_receipt_register" style="width:210px; height:30px;" required>
        </td>
      </tr>
      <!-- <tr>
...
var today=new Date();
	$('#periode_adt').datetimespinner({
		...
		selections:[[0,3],[4,8]],
		value: parseInt(today.getMonth()+1)+'-'+today.getFullYear()
	});
