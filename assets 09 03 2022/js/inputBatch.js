        ...
        if(e.which == 13){
            ...
            if(value.length < 6){
                ...
                /*if (parseInt(value.substring(7, 9)) > parseInt(getdate.substring(0,2))) {
                    tgl_sales = ((value.substring(7, 9))<10?('0'+(parseInt(value.substring(7, 9)))):(value.substring(7, 9)))+'-'+(((parseInt(getdate.substring(2,4))-1)<10?('0'+(parseInt(getdate.substring(2,4))-1)):(parseInt(getdate.substring(2,4))-1)))+'-'+parseInt(getdate.substring(4));
                }else{
                    tgl_sales = ((value.substring(7, 9))<10?('0'+(parseInt(value.substring(7, 9)))):(value.substring(7, 9)))+'-'+((parseInt(getdate.substring(2,4)))<10?('0'+(parseInt(getdate.substring(2,4)))):(parseInt(getdate.substring(2,4))))+'-'+parseInt(getdate.substring(4));
                }
                $.ajax({
                    method:"POST",
                    async:false,
                    url:base_url+"inputBatch/cek_sales",
                    data:{
                        store:storeID,
                        tgl:tgl_sales
                    },
                                                    ...
                                                    success: function(msg) {
                                                        if (msg > 0) {
                                                            ...
                                                            if ($("#flagshift").combobox('getValue') == 'H-1') {
                                                                ...
                                                                flag = $("#flagshift").combobox('getValue');
                                                            }
