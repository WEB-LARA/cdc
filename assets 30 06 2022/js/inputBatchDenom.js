...
$(document).ready(function(){
    ...
    $("#save-stl").click(function(event) {
        ...
        if (category != '' && desc != '' && date != '' && amount != '') {
            $.ajax({
                url: base_url+'InputBatchDenom/save_data_stl/',
                type: 'POST',
                data: {
                    stl_id: stl_id,
                    rec_id: rec_id,
    ...
    $("#data-trx-stl").datagrid({
        url: base_url+'InputBatchDenom/get_data_stl/',
        striped: true,
        rownumbers:true,
        remoteSort:false,
        pagination:true,
...
{
     // 100.000
     var rp_fisik_100000=$('#rp-fisik-100000').numberbox('getValue');
     // 50.000
     var rp_fisik_50000=$('#rp-fisik-50000').numberbox('getValue');
     // 20.000
     var rp_fisik_20000=$('#rp-fisik-20000').numberbox('getValue');
     // 10.000
     var rp_fisik_10000=$('#rp-fisik-10000').numberbox('getValue');
     // 5.000
     var rp_fisik_5000=$('#rp-fisik-5000').numberbox('getValue');
     // 20.000
     var rp_fisik_2000=$('#rp-fisik-2000').numberbox('getValue');
     // 1000
     var rp_fisik_1000=$('#rp-fisik-1000').numberbox('getValue');
     // 500
     var rp_fisik_500=$('#rp-fisik-500').numberbox('getValue');
     // 200
     var rp_fisik_200=$('#rp-fisik-200').numberbox('getValue');
      // 100
     var rp_fisik_100=$('#rp-fisik-100').numberbox('getValue');
     // 50
     var rp_fisik_50=$('#rp-fisik-50').numberbox('getValue');
     // 25
     var rp_fisik_25=$('#rp-fisik-25').numberbox('getValue');
      
     var total_rp_fisik=parseInt(rp_fisik_100000)+parseInt(rp_fisik_50000)+parseInt(rp_fisik_20000)+parseInt(rp_fisik_10000)+parseInt(rp_fisik_5000)+parseInt(rp_fisik_2000)+parseInt(rp_fisik_1000)+parseInt(rp_fisik_500)+parseInt(rp_fisik_200)+parseInt(rp_fisik_100)+parseInt(rp_fisik_50)+parseInt(rp_fisik_25);
...
function hitung_total_selisih_rp()
{
     ...
     var total_selisih_rp=parseInt(selisih_100000)+parseInt(selisih_50000)+parseInt(selisih_20000)+parseInt(selisih_10000)+parseInt(selisih_5000)+parseInt(selisih_2000)+parseInt(selisih_1000)+parseInt(selisih_500)+parseInt(selisih_200)+parseInt(selisih_100)+parseInt(selisih_50)+parseInt(selisih_25);
...
function save_data_pengganti() {
        ...
        if (parseInt($("#total-rp-fisik").numberbox('getValue')) > 0) {
            ...
            $.ajax({
                ...
                data: {
                        ...
                        peng_amount: $("#total-rp-fisik").numberbox('getValue'),
    ...
    $("#cashPenggantian").numberbox('setValue', $("#total-rp-fisik").numberbox('getValue'));
    //note3
