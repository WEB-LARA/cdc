...
function totalGTUInput() {
    ...
    $.ajax({
        method: "POST",
        url: base_url+"InputBatchDenom/getGrandTotalShift",
        success: function (total) {
...
function totalSetor(){
    ...
    $.ajax({
        method: "POST",
        url: base_url+"InputBatchDenom/getTotalSetorShift",
        success: function (total) {
    ...
    $.ajax({
        method: "POST",
        url: base_url+"InputBatchDenom/getTotalSetorFShift",
        success: function (total) {
...
function totalSetorReject(){
    ...
    $.ajax({
        method: "POST",
        url: base_url+"InputBatchDenom/getBatchType/"+batch_id,
        success: function (msg) {
            if (msg == 'R-STJ') {
                $.ajax({
                    method: "POST",
                    url: base_url+"InputBatchDenom/getTotalSetorReject/"+$('#savBatch').attr('batchid'),
                    success: function (total) {
                        $('#totalSetor').numberbox('setValue', total); 
                    }
                });
    ...
    $.ajax({
        ...
        success: function (msg) {
            if (msg == 'R-STJ') {
                $.ajax({
                    method: "POST",
                    url: base_url+"InputBatchDenom/getTotalSetorRejectShift/"+$('#savBatch').attr('batchid'),
                    success: function (total) {
                        $('#totalSetor').numberbox('setValue', total); 
                    }
                });
...
function delete_data_stl(rec_id, stl_id) {
    $.ajax({
        url: base_url+'InputBatchDenom/delete_data_stl/',
        type: 'POST',
        data: {
            rec_id: rec_id,
            stl_id: stl_id
...
$(document).ready(function(){
    ...
    */
    ...
    //start denom
    $("#qty-fisik-100000").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-100000').numberbox('getValue');
            var qty=$('#qty-pengganti-100000').numberbox('getValue');
            $('#rp-fisik-100000').numberbox('setValue',pengali(value,100000));
            $('#selisih-qty-100000').numberbox('setValue',selisih_qty_denom(qty,value));
            $('#selisih-rp-100000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),100000));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();

        }
    });
    $("#qty-fisik-75000").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-75000').numberbox('getValue');
            var qty=$('#qty-pengganti-75000').numberbox('getValue');
            $('#rp-fisik-75000').numberbox('setValue',pengali(value,75000));
            $('#selisih-qty-75000').numberbox('setValue',selisih_qty_denom(qty,value));
            $('#selisih-rp-75000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),75000));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
    ...
    $("#qty-fisik-50000").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-50000').numberbox('getValue');
            var qty=$('#qty-pengganti-50000').numberbox('getValue');
            $('#rp-fisik-50000').numberbox('setValue',pengali(value,50000));
            $('#selisih-qty-50000').numberbox('setValue',selisih_qty_denom(qty,value));
            $('#selisih-rp-50000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),50000));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
    ...
    $("#qty-fisik-20000").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-20000').numberbox('getValue');
            var qty=$('#qty-pengganti-20000').numberbox('getValue');
            $('#rp-fisik-20000').numberbox('setValue',pengali(value,20000));
            $('#selisih-qty-20000').numberbox('setValue',selisih_qty_denom(qty,value));            
            $('#selisih-rp-20000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),20000));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
    ...
    $("#qty-fisik-10000").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-10000').numberbox('getValue');
            var qty=$('#qty-pengganti-10000').numberbox('getValue');
            $('#rp-fisik-10000').numberbox('setValue',pengali(value,10000));
            $('#selisih-qty-10000').numberbox('setValue',selisih_qty_denom(qty,value));
            $('#selisih-rp-10000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),10000));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
    ...
    $("#qty-fisik-5000").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-5000').numberbox('getValue');
            var qty=$('#qty-pengganti-5000').numberbox('getValue');
            $('#rp-fisik-5000').numberbox('setValue',pengali(value,5000));
            $('#selisih-qty-5000').numberbox('setValue',selisih_qty_denom(qty,value));
            $('#selisih-rp-5000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),5000));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
    ...
    $("#qty-fisik-2000").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-2000').numberbox('getValue');
            var qty=$('#qty-pengganti-2000').numberbox('getValue');
            $('#rp-fisik-2000').numberbox('setValue',pengali(value,2000));
            $('#selisih-qty-2000').numberbox('setValue',selisih_qty_denom(qty,value));            
            $('#selisih-rp-2000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),2000));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
    ...
    $("#qty-fisik-1000").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-1000').numberbox('getValue');
            var qty=$('#qty-pengganti-1000').numberbox('getValue');
            $('#rp-fisik-1000').numberbox('setValue',pengali(value,1000));
            $('#selisih-qty-1000').numberbox('setValue',selisih_qty_denom(qty,value));            
            $('#selisih-rp-1000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),1000));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
    ...
    $("#qty-fisik-500").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-500').numberbox('getValue');
            var qty=$('#qty-pengganti-500').numberbox('getValue');
            $('#rp-fisik-500').numberbox('setValue',pengali(value,500));
            $('#selisih-qty-500').numberbox('setValue',selisih_qty_denom(qty,value));            
            $('#selisih-rp-500').numberbox('setValue',pengali(selisih_qty_denom(qty,value),500));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
    ...
    $("#qty-fisik-200").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-200').numberbox('getValue');
            var qty=$('#qty-pengganti-200').numberbox('getValue');
            $('#rp-fisik-200').numberbox('setValue',pengali(value,200));
            $('#selisih-qty-200').numberbox('setValue',selisih_qty_denom(qty,value));
            $('#selisih-rp-200').numberbox('setValue',pengali(selisih_qty_denom(qty,value),200));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
    ...
    $("#qty-fisik-100").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-100').numberbox('getValue');
            var qty=$('#qty-pengganti-100').numberbox('getValue');
            $('#rp-fisik-100').numberbox('setValue',pengali(value,100));
            $('#selisih-qty-100').numberbox('setValue',selisih_qty_denom(qty,value));
            $('#selisih-rp-100').numberbox('setValue',pengali(selisih_qty_denom(qty,value),100));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
    ...
    $("#qty-fisik-50").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-50').numberbox('getValue');
            var qty=$('#qty-pengganti-50').numberbox('getValue');
            $('#rp-fisik-50').numberbox('setValue',pengali(value,50));
            $('#selisih-qty-50').numberbox('setValue',selisih_qty_denom(qty,value));
            $('#selisih-rp-50').numberbox('setValue',pengali(selisih_qty_denom(qty,value),50));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
    ...
    $("#qty-fisik-25").numberbox({
        onChange: function() {
            var value=$('#qty-fisik-25').numberbox('getValue');
            var qty=$('#qty-pengganti-25').numberbox('getValue');
            $('#rp-fisik-25').numberbox('setValue',pengali(value,25));
            $('#selisih-qty-25').numberbox('setValue',selisih_qty_denom(qty,value));
            $('#selisih-rp-25').numberbox('setValue',pengali(selisih_qty_denom(qty,value),25));
            hitung_total_rp_fisik();
            hitung_total_selisih_rp();
        ...
        if (user_id != '' && no_ref != '' && no_shift != '') {
            ...
            $.ajax({
                ...
                success:function (msg) {
                    ...
                    window.location.replace(base_url+'InputBatchDenom/');
                }
            });
        } else {
    ...
    $('#data_trx_kurset').datagrid({
        url: base_url + 'InputBatchDenom/get_data_kurset_shift',
        striped: true,
        rownumbers:true,
        remoteSort:false,
        singleSelect:true,
...
//              var col = '<input type="button" id="btnDelRecKur" value="Delete" onClick="delEntry('+row.CDC_REC_ID+')">';
    ...
    $("#submit_kurset").click(function(event) {
        ...
        if (ttknum && amount > 0) {
            $.ajax({
                url: 'InputBatchDenom/set_receipt_kurset/'+ttknum+'/'+amount+'/'+trf+'/'+acc_id+'/'+mut_date,
                method: 'POST',
                success: function(msg) {
                    if (msg > 0) {
                        $("#modal_detail_kurset").window('close');
    ...
    $("#search_ttk").click(function(event) {
        event.preventDefault();
        $.ajax({
            url: 'InputBatchDenom/get_header_kurset/'+$("#ttk_num").textbox('getValue')+'/'+$("#branch_ttk").val(),
            method: 'POST',
            success: function(msg) {
                if (msg != 'X') {
                    ...
                    if (ret[0]) {
                        ...
                        $('#data_det_kurset').datagrid({
                            url: 'InputBatchDenom/get_lines_kurset/'+ret[0]['FIS_TRX_HEADER_ID']+'/'+$("#ttk_num").textbox('getValue'),
                            striped: true,
                            rownumbers:true,
                            remoteSort:false,
                            singleSelect:true,
                            ...
                            onLoadSuccess: function() {
                                $.ajax({
                                    url: 'InputBatchDenom/get_total_line/'+$("#ttk_num").textbox('getValue'),
                                    method: 'POST',
                                    success: function(msg) {
        ...
        $('#batch_reject').datagrid({
            ...
            onDblClickRow: function () {
                ...
                $('#tblTrxReceipts').datagrid({
                    url:base_url+'InputBatchDenom/getPraInputRejectShift/'+rows[0].CDC_BATCH_ID,
                    columns:[[
    ...
    */      
    ...
    $('#tblTrxReceipts').datagrid({
        url:base_url+'InputBatchDenom/getPraInputShift',
        onCheckAll: function () {
            $("#genBatch").trigger('click');
        },
        columns:[[
    ...
    //             $.ajax({
    //                 method: "POST",
    //                 url: base_url + "InputBatchDenom/scanCodeSales",
    //                 data: {
    //                     scan: value
    //                 },
    //                 success: function(msg) {
    ...
    //                     $.ajax({
    //                         method: "POST",
    //                         url: base_url + "InputBatchDenom/getSysDate",
    ...
    //                             $.ajax({
    //                                 method: "POST",
    //                                 url: base_url + "master/Toko/getStoreDenom",
    //                                 data: {
    //                                     storeCode: msg,
    //                                     shift: shift,
    //                                     salesDate: salesDate
    ...
    //                                     } else if (storeNameHasil == 'SHIFTINVALID') {

    //                                         alert('Shift Tidak Valid, Harap Cek Master Shift.');
    //                                         $('#storeCode').textbox('setValue', '');
    //                                         $('#tglSales').datebox('setValue', '');
    ...
    //                                         } else {
    //                                             alert('Shift Toko Tidak Terdaftar.');
    ...
    //                                         // $('#flagshift').combobox({
    //                                         //     url: 'InputBatchDenom/get_tipe_shift/' + msg + '/' + $('#tglSales').datebox('getValue') + '/' + salesFlag,
    //                                         //     valueField: 'SHIFT',
    //                                         //     textField: 'SHIFT_DESC'
    //                                         // });
    //                                         // alert(msg);
    ...
    //                                     method: "POST",
    //                                     async:false,
    //                                     url: base_url+"InputBatchDenom/getPraIDShift",
    //                                     success: function ($id) {
    ...
    //                                     method: "POST",
    //                                     async:false,
    //                                     url: base_url+"InputBatchDenom/getPraID",
    //                                     success: function ($id) {
    //                                             //$('#CDC_REC_ID').textbox('setValue', $id); 
    ...
    //                         method: "POST",
    //                         async: false,
    //                         url: base_url + "InputBatchDenom/getPraIDNShift",
    //                         success: function($id) {
    //                             //$('#CDC_REC_ID').textbox('setValue', $id); 
    //                             $('#CDC_REC_ID1').val($id);
    ...
    //                         method: "POST",
    //                         async: false,
    //                         url: base_url + "InputBatchDenom/getPraIDN",
    //                         success: function($id) {
    //                             //$('#CDC_REC_ID').textbox('setValue', $id);
    //                             $('#CDC_REC_REAL_ID').val($id);
...
function editEntryShift(recId, isStn){
    ...
    $.ajax({
        method: "POST",
        url: base_url+"InputBatchDenom/getDataDetailShift/"+recID+'/'+isSTN,
        ...
        if(data['NO_SHIFT']=='H')
        {        
            $('#flagshift').combobox('setValue','HARIAN');

        }else if(data['NO_SHIFT']=='S-1')
        {
            $('#flagshift').combobox('setValue','SHIFT-1');

        }else if(data['NO_SHIFT']=='S-2')
        {
            $('#flagshift').combobox('setValue','SHIFT-2');

        }else if(data['NO_SHIFT']=='S-3')
        {
            $('#flagshift').combobox('setValue','SHIFT-3');
...
function delEntryShift(recshiftId,recid,no_shift){
    $.messager.confirm('Confirm','Apakah anda yakin untuk menghapus data ini?',function(r){
        if (r){
            ...
            $.ajax({
                method: "POST",
                url: base_url+"InputBatchDenom/delPraInputShift/"+recshiftId+'/'+recid+'/'+no_shift,

                success: function (a) {
                    $('#tblTrxReceipts').datagrid('reload', base_url+'InputBatchDenom/getPraInputShift');
                    $("#data_trx_kurset").datagrid('reload');
                    totalSetor();
                }
            });         
...
function editEntry(recId, isStn){
    ...
    $.ajax({
        method: "POST",
        url: base_url+"InputBatchDenom/getDataDetail/"+recID+'/'+isSTN,
...
function delEntry(recId){
    $.messager.confirm('Confirm','Apakah anda yakin untuk menghapus data ini?',function(r){
        if (r){
            ...
            $.ajax({
                method: "POST",
                url: base_url+"InputBatchDenom/delPraInput/"+recId,

                success: function (a) {
                    $('#tblTrxReceipts').datagrid('reload', base_url+'InputBatchDenom/getPraInput');
                    $("#data_trx_kurset").datagrid('reload');
                    totalSetor();
                }
            });         
...
function penggantian(){
    ...
    $('#label-100000').numberbox('setValue',100000);
    $('#label-75000').numberbox('setValue',75000);
    $('#label-50000').numberbox('setValue',50000);
    $('#label-20000').numberbox('setValue',20000);
    $('#label-10000').numberbox('setValue',10000);
    $('#label-5000').numberbox('setValue',5000);
    $('#label-2000').numberbox('setValue',2000);
    $('#label-1000').numberbox('setValue',1000);
    $('#label-500').numberbox('setValue',500);
    $('#label-200').numberbox('setValue',200);
    $('#label-100').numberbox('setValue',100);
    $('#label-50').numberbox('setValue',50);
    $('#label-25').numberbox('setValue',25);
    $('#qty-pengganti-100000').numberbox('setValue',0);
    $('#nominal-pengganti-100000').numberbox('setValue',0);
    $('#qty-fisik-100000').numberbox('setValue',0);
    $('#rp-fisik-100000').numberbox('setValue',0);
    $('#selisih-qty-100000').numberbox('setValue',0);
    $('#selisih-rp-100000').numberbox('setValue',0);
    $('#qty-pengganti-75000').numberbox('setValue',0);
    $('#nominal-pengganti-75000').numberbox('setValue',0);
    $('#qty-fisik-75000').numberbox('setValue',0);
    $('#rp-fisik-75000').numberbox('setValue',0);
    $('#selisih-qty-75000').numberbox('setValue',0);
    $('#selisih-rp-75000').numberbox('setValue',0);
    $('#qty-pengganti-50000').numberbox('setValue',0);
    $('#nominal-pengganti-50000').numberbox('setValue',0);
    $('#qty-fisik-50000').numberbox('setValue',0);
    $('#rp-fisik-50000').numberbox('setValue',0);
    $('#selisih-qty-50000').numberbox('setValue',0);
    $('#selisih-rp-50000').numberbox('setValue',0);
    $('#qty-pengganti-20000').numberbox('setValue',0);
    $('#nominal-pengganti-20000').numberbox('setValue',0);
    $('#qty-fisik-20000').numberbox('setValue',0);
    $('#rp-fisik-20000').numberbox('setValue',0);
    $('#selisih-qty-20000').numberbox('setValue',0);
    $('#selisih-rp-20000').numberbox('setValue',0);
    $('#qty-pengganti-10000').numberbox('setValue',0);
    $('#nominal-pengganti-10000').numberbox('setValue',0);
    $('#qty-fisik-10000').numberbox('setValue',0);
    $('#rp-fisik-10000').numberbox('setValue',0);
    $('#selisih-qty-10000').numberbox('setValue',0);
    $('#selisih-rp-10000').numberbox('setValue',0);
    $('#qty-pengganti-5000').numberbox('setValue',0);
    $('#nominal-pengganti-5000').numberbox('setValue',0);
    $('#qty-fisik-5000').numberbox('setValue',0);
    $('#rp-fisik-5000').numberbox('setValue',0);
    $('#selisih-qty-5000').numberbox('setValue',0);
    $('#selisih-rp-5000').numberbox('setValue',0);
    $('#qty-pengganti-2000').numberbox('setValue',0);
    $('#nominal-pengganti-2000').numberbox('setValue',0);
    $('#qty-fisik-2000').numberbox('setValue',0);
    $('#rp-fisik-2000').numberbox('setValue',0);
    $('#selisih-qty-2000').numberbox('setValue',0);
    $('#selisih-rp-2000').numberbox('setValue',0);
    $('#qty-pengganti-1000').numberbox('setValue',0);
    $('#nominal-pengganti-1000').numberbox('setValue',0);
    $('#qty-fisik-1000').numberbox('setValue',0);
    $('#rp-fisik-1000').numberbox('setValue',0);
    $('#selisih-qty-1000').numberbox('setValue',0);
    $('#selisih-rp-1000').numberbox('setValue',0);
    $('#qty-pengganti-500').numberbox('setValue',0);
    $('#nominal-pengganti-500').numberbox('setValue',0);
    $('#qty-fisik-500').numberbox('setValue',0);
    $('#rp-fisik-500').numberbox('setValue',0);
    $('#selisih-qty-500').numberbox('setValue',0);
    $('#selisih-rp-500').numberbox('setValue',0);
    $('#qty-pengganti-200').numberbox('setValue',0);
    $('#nominal-pengganti-200').numberbox('setValue',0);
    $('#qty-fisik-200').numberbox('setValue',0);
    $('#rp-fisik-200').numberbox('setValue',0);
    $('#selisih-qty-200').numberbox('setValue',0);
    $('#selisih-rp-200').numberbox('setValue',0);
    $('#qty-pengganti-100').numberbox('setValue',0);
    $('#nominal-pengganti-100').numberbox('setValue',0);
    $('#qty-fisik-100').numberbox('setValue',0);
    $('#rp-fisik-100').numberbox('setValue',0);
    $('#selisih-qty-100').numberbox('setValue',0);
    $('#selisih-rp-100').numberbox('setValue',0);
    $('#qty-pengganti-50').numberbox('setValue',0);
    $('#nominal-pengganti-50').numberbox('setValue',0);
    $('#qty-fisik-50').numberbox('setValue',0);
    $('#rp-fisik-50').numberbox('setValue',0);
    $('#selisih-qty-50').numberbox('setValue',0);
    $('#selisih-rp-50').numberbox('setValue',0);
    $('#qty-pengganti-25').numberbox('setValue',0);
    $('#nominal-pengganti-25').numberbox('setValue',0);
    $('#qty-fisik-25').numberbox('setValue',0);
    $('#rp-fisik-25').numberbox('setValue',0);
    $('#selisih-qty-25').numberbox('setValue',0);
    $('#selisih-rp-25').numberbox('setValue',0);

    $('#rp-fisik-25').numberbox('setValue',0);
    $('#selisih-qty-25').numberbox('setValue',0);
    $('#selisih-rp-25').numberbox('setValue',0);

    $('#total-pengganti').numberbox('setValue',0);
    $('#total-rp-fisik').numberbox('setValue',0);
    $('#total-selisih-rp').numberbox('setValue',0);
    
    var store = $("#storeCode").textbox('getValue');
    var salesDate=$('#tglSales').datebox('getValue');
    var tipe_shift=$('#flagshift').combobox('getValue');
    $('#labelShift').textbox('setValue',tipe_shift);
    var rec = $('#CDC_REC_ID1').val();

    //AMBIL DATA DENOM SD7
    $.ajax({
                url: base_url+'input/Trx_Ganti/get_data_denom_sd7/',
                method: 'POST',
                dataType: 'json',
                data: {
                        store: store,
                ...
                success: function (res) {
                    if (res) {
                       tampilSelisih='TRUE';
                       var respons = JSON.parse(JSON.stringify(res));
                        $('#qty-pengganti-100000').numberbox('setValue',respons['100000_RP']);
                        $('#qty-pengganti-75000').numberbox('setValue',respons['75000_RP']);
                        $('#qty-pengganti-50000').numberbox('setValue',respons['50000_RP']);
                        $('#qty-pengganti-20000').numberbox('setValue',respons['20000_RP']);
                        $('#qty-pengganti-10000').numberbox('setValue',respons['10000_RP']);
                        $('#qty-pengganti-5000').numberbox('setValue',respons['5000_RP']);
                        $('#qty-pengganti-2000').numberbox('setValue',respons['2000_RP']);
                        $('#qty-pengganti-1000').numberbox('setValue',respons['1000_RP']);
                        $('#qty-pengganti-500').numberbox('setValue',respons['500_RP']);
                        $('#qty-pengganti-200').numberbox('setValue',respons['200_RP']);
                        $('#qty-pengganti-100').numberbox('setValue',respons['100_RP']);
                        $('#qty-pengganti-50').numberbox('setValue',respons['50_RP']);
                        $('#qty-pengganti-25').numberbox('setValue',respons['25_RP']);

                        hitung_nominal_pengganti();
                        $.ajax({
                            ...
                            success: function (res) {
                                if (res.length > 0) {
                                    //note1
                                     var value=0;
                                     var qty=0;
                                     $("#pengid").val(res[0].TRX_DETAIL_PENG_ID);
                                     $('#id_receipt_denom').val(res[0].ID);
                                     $('#qty-fisik-100000').numberbox('setValue',res[0].QTY_100000);
                                     value=$('#qty-fisik-100000').numberbox('getValue');
                                     qty=$('#qty-pengganti-100000').numberbox('getValue');
                                     $('#rp-fisik-100000').numberbox('setValue',pengali(value,100000));
                                     $('#selisih-qty-100000').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-100000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),100000));

                                     $('#qty-fisik-75000').numberbox('setValue',res[0].QTY_75000);
                                     value=$('#qty-fisik-75000').numberbox('getValue');
                                     qty=$('#qty-pengganti-75000').numberbox('getValue');
                                     $('#rp-fisik-75000').numberbox('setValue',pengali(value,75000));
                                     $('#selisih-qty-75000').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-75000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),75000));

                                     $('#qty-fisik-50000').numberbox('setValue',res[0].QTY_50000);
                                     value=$('#qty-fisik-50000').numberbox('getValue');
                                     qty=$('#qty-pengganti-50000').numberbox('getValue');
                                     $('#rp-fisik-50000').numberbox('setValue',pengali(value,50000));
                                     $('#selisih-qty-50000').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-50000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),50000));

                                     $('#qty-fisik-20000').numberbox('setValue',res[0].QTY_20000);
                                     value=$('#qty-fisik-20000').numberbox('getValue');
                                     qty=$('#qty-pengganti-20000').numberbox('getValue');
                                     $('#rp-fisik-20000').numberbox('setValue',pengali(value,20000));
                                     $('#selisih-qty-20000').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-20000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),20000));


                                     $('#qty-fisik-10000').numberbox('setValue',res[0].QTY_10000);
                                     value=$('#qty-fisik-10000').numberbox('getValue');
                                     qty=$('#qty-pengganti-10000').numberbox('getValue');
                                     $('#rp-fisik-10000').numberbox('setValue',pengali(value,10000));
                                     $('#selisih-qty-10000').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-10000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),10000));


                                     $('#qty-fisik-5000').numberbox('setValue',res[0].QTY_5000);
                                     value=$('#qty-fisik-5000').numberbox('getValue');
                                     qty=$('#qty-pengganti-5000').numberbox('getValue');
                                     $('#rp-fisik-5000').numberbox('setValue',pengali(value,5000));
                                     $('#selisih-qty-5000').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-5000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),5000));


                                     $('#qty-fisik-2000').numberbox('setValue',res[0].QTY_2000);
                                     value=$('#qty-fisik-2000').numberbox('getValue');
                                     qty=$('#qty-pengganti-2000').numberbox('getValue');
                                     $('#rp-fisik-2000').numberbox('setValue',pengali(value,2000));
                                     $('#selisih-qty-2000').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-2000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),2000));


                                     $('#qty-fisik-1000').numberbox('setValue',res[0].QTY_1000);
                                     value=$('#qty-fisik-1000').numberbox('getValue');
                                     qty=$('#qty-pengganti-1000').numberbox('getValue');
                                     $('#rp-fisik-1000').numberbox('setValue',pengali(value,1000));
                                     $('#selisih-qty-1000').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-1000').numberbox('setValue',pengali(selisih_qty_denom(qty,value),1000));
                                     ...
                                     $('#qty-fisik-500').numberbox('setValue',res[0].QTY_500);
                                     value=$('#qty-fisik-500').numberbox('getValue');
                                     qty=$('#qty-pengganti-500').numberbox('getValue');
                                     $('#rp-fisik-500').numberbox('setValue',pengali(value,500));
                                     $('#selisih-qty-500').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-500').numberbox('setValue',pengali(selisih_qty_denom(qty,value),500));

                                     $('#qty-fisik-200').numberbox('setValue',res[0].QTY_200);
                                     value=$('#qty-fisik-200').numberbox('getValue');
                                     qty=$('#qty-pengganti-200').numberbox('getValue');
                                     $('#rp-fisik-200').numberbox('setValue',pengali(value,200));
                                     $('#selisih-qty-200').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-200').numberbox('setValue',pengali(selisih_qty_denom(qty,value),200));

                                     $('#qty-fisik-100').numberbox('setValue',res[0].QTY_100);
                                     value=$('#qty-fisik-100').numberbox('getValue');
                                     qty=$('#qty-pengganti-100').numberbox('getValue');
                                     $('#rp-fisik-100').numberbox('setValue',pengali(value,100));
                                     $('#selisih-qty-100').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-100').numberbox('setValue',pengali(selisih_qty_denom(qty,value),100));

                                     $('#qty-fisik-50').numberbox('setValue',res[0].QTY_50);
                                     value=$('#qty-fisik-50').numberbox('getValue');
                                     qty=$('#qty-pengganti-50').numberbox('getValue');
                                     $('#rp-fisik-50').numberbox('setValue',pengali(value,50));
                                     $('#selisih-qty-50').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-50').numberbox('setValue',pengali(selisih_qty_denom(qty,value),50));

                                     $('#qty-fisik-25').numberbox('setValue',res[0].QTY_25);
                                     value=$('#qty-fisik-25').numberbox('getValue');
                                     qty=$('#qty-pengganti-25').numberbox('getValue');
                                     $('#rp-fisik-25').numberbox('setValue',pengali(value,25));
                                     $('#selisih-qty-25').numberbox('setValue',selisih_qty_denom(qty,value));
                                     $('#selisih-rp-25').numberbox('setValue',pengali(selisih_qty_denom(qty,value),25));
                                     hitung_total_rp_fisik();
...
function hitung_nominal_pengganti()
{
     // 100.000
     var qty_pengganti_100000=$('#qty-pengganti-100000').numberbox('getValue');
     var nominal_pengganti_100000=qty_pengganti_100000*100000;
     $('#nominal-pengganti-100000').numberbox('setValue',nominal_pengganti_100000);

     //75.000
     var qty_pengganti_75000=$('#qty-pengganti-75000').numberbox('getValue');
     var nominal_pengganti_75000=qty_pengganti_75000*75000;
     $('#nominal-pengganti-75000').numberbox('setValue',nominal_pengganti_75000);

     //50.000
     var qty_pengganti_50000=$('#qty-pengganti-50000').numberbox('getValue');
     var nominal_pengganti_50000=qty_pengganti_50000*50000;
     $('#nominal-pengganti-50000').numberbox('setValue',nominal_pengganti_50000);


     //20.000
     var qty_pengganti_20000=$('#qty-pengganti-20000').numberbox('getValue');
     var nominal_pengganti_20000=qty_pengganti_20000*20000;
     $('#nominal-pengganti-20000').numberbox('setValue',nominal_pengganti_20000);
    // 10000
     var qty_pengganti_10000=$('#qty-pengganti-10000').numberbox('getValue');
     var nominal_pengganti_10000=qty_pengganti_10000*10000;
     $('#nominal-pengganti-10000').numberbox('setValue',nominal_pengganti_10000);
     //5000
     var qty_pengganti_5000=$('#qty-pengganti-5000').numberbox('getValue');
     var nominal_pengganti_5000=qty_pengganti_5000*5000;
     $('#nominal-pengganti-5000').numberbox('setValue',nominal_pengganti_5000);
     //2000
     var qty_pengganti_2000=$('#qty-pengganti-2000').numberbox('getValue');
     var nominal_pengganti_2000=qty_pengganti_2000*2000;
     $('#nominal-pengganti-2000').numberbox('setValue',nominal_pengganti_2000);
     //1000
     var qty_pengganti_1000=$('#qty-pengganti-1000').numberbox('getValue');
     var nominal_pengganti_1000=qty_pengganti_1000*1000;
     $('#nominal-pengganti-1000').numberbox('setValue',nominal_pengganti_1000);
     //500
     var qty_pengganti_500=$('#qty-pengganti-500').numberbox('getValue');
     var nominal_pengganti_500=qty_pengganti_500*500;
     $('#nominal-pengganti-500').numberbox('setValue',nominal_pengganti_500);
     //200
     var qty_pengganti_200=$('#qty-pengganti-200').numberbox('getValue');
     var nominal_pengganti_200=qty_pengganti_200*200;
     $('#nominal-pengganti-200').numberbox('setValue',nominal_pengganti_200);
     //100
     var qty_pengganti_100=$('#qty-pengganti-100').numberbox('getValue');
     var nominal_pengganti_100=qty_pengganti_100*100;
     $('#nominal-pengganti-100').numberbox('setValue',nominal_pengganti_100);
     //50
     var qty_pengganti_50=$('#qty-pengganti-50').numberbox('getValue');
     var nominal_pengganti_50=qty_pengganti_50*50;
     $('#nominal-pengganti-50').numberbox('setValue',nominal_pengganti_50);
     //25
     var qty_pengganti_25=$('#qty-pengganti-25').numberbox('getValue');
     var nominal_pengganti_25=qty_pengganti_25*25;
     $('#nominal-pengganti-25').numberbox('setValue',nominal_pengganti_25);


     var total_pengganti=parseInt(nominal_pengganti_100000)+parseInt(nominal_pengganti_75000)+parseInt(nominal_pengganti_50000)+parseInt(nominal_pengganti_20000)+parseInt(nominal_pengganti_10000)+parseInt(nominal_pengganti_5000)+parseInt(nominal_pengganti_2000)+parseInt(nominal_pengganti_1000)+parseInt(nominal_pengganti_500)+parseInt(nominal_pengganti_200)+parseInt(nominal_pengganti_100)+parseInt(nominal_pengganti_50)+parseInt(nominal_pengganti_25);
     $('#total-pengganti').numberbox('setValue',total_pengganti);

}



function hitung_total_rp_fisik()
{
    var total_rp_fisik=0;
    var rp_fisik_100000=0;
    var rp_fisik_75000=0;
    var rp_fisik_50000=0;
    var rp_fisik_20000=0;
    var rp_fisik_10000=0;
    var rp_fisik_5000=0;
    var rp_fisik_2000=0;
    var rp_fisik_1000=0;
    var rp_fisik_500=0;
    ...
    var rp_fisik_25=0;
     ...
     // 100.000
     rp_fisik_100000=$('#rp-fisik-100000').numberbox('getValue');
    // 75.000
     rp_fisik_75000=$('#rp-fisik-75000').numberbox('getValue');
     // 50.000
     rp_fisik_50000=$('#rp-fisik-50000').numberbox('getValue');
     // 20.000
     rp_fisik_20000=$('#rp-fisik-20000').numberbox('getValue');
     // 10.000
     rp_fisik_10000=$('#rp-fisik-10000').numberbox('getValue');
     // 5.000
     rp_fisik_5000=$('#rp-fisik-5000').numberbox('getValue');
     // 20.000
     rp_fisik_2000=$('#rp-fisik-2000').numberbox('getValue');
     // 1000
     rp_fisik_1000=$('#rp-fisik-1000').numberbox('getValue');
     // 500
     rp_fisik_500=$('#rp-fisik-500').numberbox('getValue');
     // 200
     rp_fisik_200=$('#rp-fisik-200').numberbox('getValue');
      // 100
     rp_fisik_100=$('#rp-fisik-100').numberbox('getValue');
     // 50
     rp_fisik_50=$('#rp-fisik-50').numberbox('getValue');
     // 25
     rp_fisik_25=$('#rp-fisik-25').numberbox('getValue');
      
    total_rp_fisik=parseInt(parseInt(rp_fisik_100000)+
                        parseInt(rp_fisik_75000)+
                        parseInt(rp_fisik_50000)+
                        parseInt(rp_fisik_20000)+
                        parseInt(rp_fisik_10000)+
                        parseInt(rp_fisik_5000)+
                        parseInt(rp_fisik_2000)+
                        parseInt(rp_fisik_1000)+
                        parseInt(rp_fisik_500)+
                        parseInt(rp_fisik_200)+
                        parseInt(rp_fisik_100)+
                        parseInt(rp_fisik_50)+
                        parseInt(rp_fisik_25));


     
     // if($('#total-selisih-rp').numberbox('getValue')<0)
     // {
     //    total_rp_fisik=parseInt(total_rp_fisik)+parseInt($('#total-selisih-rp').numberbox('getValue'));
     // }

     $('#total-rp-fisik').numberbox('setValue',total_rp_fisik);

}


function hitung_total_selisih_rp()
{
     // 100.000
     var selisih_100000=$('#selisih-rp-100000').numberbox('getValue');
     // 75.000
     var selisih_75000=$('#selisih-rp-75000').numberbox('getValue');
     // 50.000
     var selisih_50000=$('#selisih-rp-50000').numberbox('getValue');
     // 20.000
     var selisih_20000=$('#selisih-rp-20000').numberbox('getValue');
     // 10.000
     var selisih_10000=$('#selisih-rp-10000').numberbox('getValue');
     // 5.000
     var selisih_5000=$('#selisih-rp-5000').numberbox('getValue');
     // 20.000
     var selisih_2000=$('#selisih-rp-2000').numberbox('getValue');
     // 1000
     var selisih_1000=$('#selisih-rp-1000').numberbox('getValue');
     // 500
     var selisih_500=$('#selisih-rp-500').numberbox('getValue');
     // 200
     var selisih_200=$('#selisih-rp-200').numberbox('getValue');
      // 100
     var selisih_100=$('#selisih-rp-100').numberbox('getValue');
     // 50
     var selisih_50=$('#selisih-rp-50').numberbox('getValue');
     // 25
     var selisih_25=$('#selisih-rp-25').numberbox('getValue');
      
     var total_selisih_rp=parseInt(selisih_75000)+parseInt(selisih_100000)+parseInt(selisih_50000)+parseInt(selisih_20000)+parseInt(selisih_10000)+parseInt(selisih_5000)+parseInt(selisih_2000)+parseInt(selisih_1000)+parseInt(selisih_500)+parseInt(selisih_200)+parseInt(selisih_100)+parseInt(selisih_50)+parseInt(selisih_25);
     $('#total-selisih-rp').numberbox('setValue',total_selisih_rp);
     var total_rp_fisik= $('#total-rp-fisik').numberbox('getValue');
...
function pengali(qty,nominal)
{
    return qty*nominal;
}

function selisih_qty_denom(qty,qty_input)
{
    var selisih=0;
    if(tampilSelisih=='FALSE')
    {
        selisih=0;
    }else{
        selisih=qty-qty_input;
    }
    return selisih;
}
...
function save_data_pengganti() {
  ...
  //dsini
    //note2
    var penggantian=0;
    if ($('#total-rp-fisik').numberbox('getValue') != '') {
        if (parseInt($("#total-rp-fisik").numberbox('getValue')) > 0) {
            if(parseInt($('#total-selisih-rp').numberbox('getValue'))<0)
            {
                penggantian=parseInt($("#total-rp-fisik").numberbox('getValue'))+parseInt($('#total-selisih-rp').numberbox('getValue'));
               // alert(penggantian+'UDAH BENER');
            }else{
                penggantian=parseInt($("#total-rp-fisik").numberbox('getValue'));
               // alert(penggantian+'ANEH');
            }   
            $.ajax({
                ...
                data: {
                        id: $("#pengid").val(),
                        rec_id: $('#CDC_REC_ID1').val(),
                        no_shift: $('#labelShift').textbox('getValue'),
                        peng_amount:penggantian,
                ...
                success: function (msg) {
                    if (msg == 0) {
                        ...
                        $.ajax({
                            url: base_url+'input/Trx_Ganti/save_data_input_denom/',
                            type: 'POST',
                            data: {
                                    rec_id: $('#CDC_REC_ID1').val(),
                                    no_shift: $('#labelShift').textbox('getValue'),
                                    qty_100000: $("#qty-fisik-100000").numberbox('getValue'),
                                    qty_75000: $("#qty-fisik-75000").numberbox('getValue'),
                                    qty_50000: $("#qty-fisik-50000").numberbox('getValue'),
                                    qty_20000: $("#qty-fisik-20000").numberbox('getValue'),
                                    qty_10000: $("#qty-fisik-10000").numberbox('getValue'),
                                    qty_5000: $("#qty-fisik-5000").numberbox('getValue'),
                                    qty_2000: $("#qty-fisik-2000").numberbox('getValue'),
                                    qty_1000: $("#qty-fisik-1000").numberbox('getValue'),
                                    qty_500: $("#qty-fisik-500").numberbox('getValue'),
                                    qty_200: $("#qty-fisik-200").numberbox('getValue'),
                                    qty_100: $("#qty-fisik-100").numberbox('getValue'),
                                    qty_50: $("#qty-fisik-50").numberbox('getValue'),
                                    qty_25: $("#qty-fisik-25").numberbox('getValue'),
                                    id:$('#id_receipt_denom').val()
            ...
            if ($("#id_receipt_denom").val() != '') {
                $.ajax({
                        url: base_url+'input/Trx_Ganti/delete_data_pengganti_denom/',
                        type: 'POST',
                        data: {
                                peng_del_id: $("#pengid").val(),
                                receipt_denom_id:$('#id_receipt_denom').val()
                        },
                        success: function(msg) {
                            if (msg == 0) {
                                $.messager.alert('Warning','Terjadi kesalahan, mohon untuk refresh page kemudian dicoba kembali.');
    ...
    $("#cashPenggantian").numberbox('setValue',penggantian);
    //note3
    //harusnya abis ini kalau ada selisih save data pengurang 
    if($('#total-selisih-rp').numberbox('getValue')>0 || $('#total-selisih-rp').numberbox('getValue')==0 )
    {
        $("#kur-date").val($("#tglSales").datebox('getValue'));
        var kur_date=$('#kur-date').val();
        var kurset=0;
        kurset+=parseInt($('#total-selisih-rp').numberbox('getValue'));
        ...
        success: function (msg) {
             if (kurset != '' && kurset>0) {
                     $.ajax({
                            url: base_url+'input/Trx_Kurang/save_data_pengurang_shift_denom/',
                            type: 'POST',
                            data: {
                                id: $("#kurid[27]").val(),
                                rec_id: $('#CDC_REC_ID1').val(),
                                no_shift: $('#flagshift').textbox('getValue'),
                                real_id: $('#CDC_REC_REAL_ID').val(),
                                min_id: msg[0].TRX_MINUS_ID,
                                min_date: $("#kur-date").val(),
                                min_desc: msg[0].TRX_MINUS_DESC+' '+$('#storeCode').textbox('getValue')+' '+kur_date.replace(/-/gi, '/'),
                                min_amount: kurset,
                                batch_id : $("#savBatch").attr('batchid')
                            },
                            success: function (msg) {
    ...
    $("#gtotal-pengurang-amt-shift").numberbox('setValue',kurset);
    $("#total-pengurang-amt").numberbox('setValue',kurset)
    $("#totalPengurang").numberbox('setValue', $("#total-pengurang-amt").numberbox('getValue'));
    }else{
        //jika selisih nya - berarti itu lebih setor -> masuk ke akun lebih setor
        $("#pendate[13]").val($("#tglSales").datebox('getValue'));
        var lebih_setor=0;
        lebih_setor+=parseInt(Math.abs($('#total-selisih-rp').numberbox('getValue')));
        if (lebih_setor != '' && lebih_setor > 0) {
            ...
            $.ajax({
                    ...
                    success: function (msg) {
                        $.ajax({
                                    url: base_url+'input/Trx_Tambah/save_data_penambah_shift_denom/',
                                    type: 'POST',
                                    data: {
                                        id: $("#penid[13]").val(),
                                        rec_id: $('#CDC_REC_ID1').val(),
                                        no_shift: $('#flagshift').textbox('getValue') ,
                                        real_id: $('#CDC_REC_REAL_ID').val(),
                                        plus_id: msg[3].TRX_PLUS_ID,
                                        plus_date: $("#tglSales").datebox('getValue'),
                                        plus_desc:  msg[3].TRX_PLUS_DESC+' '+$('#storeCode').textbox('getValue')+' '+$("#tglSales").datebox('getValue').replace(/-/gi, '/'),
                                        plus_amount:lebih_setor,
                                        batch_id : $("#savBatch").attr('batchid')
                                    },
                                    success: function (msg) {
                                        if (msg == 0) {
                                            ...
                                            $("#gtotal-penambah-amt-shift").numberbox('setValue',lebih_setor);
                                            $("#total-penambah-amt").numberbox('setValue',lebih_setor)
                                            $("#totalPenambah").numberbox('setValue', $("#total-penambah-amt").numberbox('getValue'));
...
function salesharianshift(){
    ...
    if ($("#flagshift").combobox('getValue') == 'H-1') {
        ...
        flag1 = 'H';
    } else if ($("#flagshift").combobox('getValue') == 'SHIFT-1'){
        flag1 = 'S-1';
    } else if ($("#flagshift").combobox('getValue') == 'SHIFT-2'){
        flag1 = 'S-2';
    } else if ($("#flagshift").combobox('getValue') == 'SHIFT-3'){
        flag1 = 'S-3';
    }
    var start_input_time = $('#start_input_time').textbox('getValue');
    ...
    $.ajax({
    method: "POST",
    url: base_url + "InputBatchDenom/cekTrxBefore/",
    data: {
    ...
    success: function(msg) {
        ...
        if (msg == "TRUE") {
            ...
            $.ajax({
                method: "POST",
                url: base_url + "InputBatchDenom/cekTanggal/",
                data: {
                    sales_date: $("#tglSales").datebox('getValue')
                },
                success: function(msg) {
                    if (msg == 0) {
                        ...
                        if (recStatus == 'n') {
                            $.ajax({
                                method: "POST",
                                url: base_url + "InputBatchDenom/cekDataShift/",
                                data: {
                                    store_code: $("#storeCode").textbox('getValue'),
                                    sales_date: $("#tglSales").datebox('getValue'),
                                    ...
                                    if (hasilCek < 1) {
                                        ...
                                        if (checking) {
                                            if ($("#cashPenggantian").textbox('getValue') <= 0 && salesFlag == 'Y') {
                                                ...
                                                $.ajax({
                                                    method: 'POST',
                                                    url: base_url + "InputBatchDenom/cek_trx_detail_shift",
                                                    data: {
                                                    ...
                                                    success: function(msg) {
                                                        if (msg > 0) {
                                                            ...
                                                            if ($("#flagshift").combobox('getValue') == 'H-1' || $("#flagshift").combobox('getValue') == 'HARIAN-SHIFT') {
                                                                ...
                                                                flag = 'H';
                                                            } else if($("#flagshift").combobox('getValue') == 's-1' || $("#flagshift").combobox('getValue') == 'SHIFT-1'){
                                                                flag = 'S-1';
                                                            }else if($("#flagshift").combobox('getValue') == 's-2' || $("#flagshift").combobox('getValue') == 'SHIFT-2'){
                                                                flag = 'S-2';
                                                            }else if($("#flagshift").combobox('getValue') == 's-3' || $("#flagshift").combobox('getValue') == 'SHIFT-3'){
                                                                flag = 'S-3';
                                                            }
                                                            ...
                                                            $.ajax({
                                                                method: "POST",
                                                                url: base_url + "InputBatchDenom/praInputShift",
                                                                data: {
                                                                    statusxx: recStatus,
                                                                ...
                                                                success: function(message) {
                                                                    if ($("#savBatch").attr('batchid') != '') {
                                                                        $('#tblTrxReceipts').datagrid('reload', base_url + 'InputBatchDenom/getPraInputRejectShift/' + $("#savBatch").attr('batchid'));
                                                                    } else {
                                                                        $('#tblTrxReceipts').datagrid('reload', base_url + 'InputBatchDenom/getPraInputShift');
                                                                    }
                                                                    $.messager.show({
                            ...
                            if ($("#cashPenggantian").textbox('getValue') <= 0) {
                                ...
                                if (kurang >= total) {
                                    ...
                                    $.ajax({
                                        method: "POST",
                                        url: base_url + "InputBatchDenom/praEditShift",
                                        data: {
                                            statusxx: recStatus,
                                            receiptID: recid,
                                            realrecid: $('#CDC_REC_REAL_ID').val(),
                        ...
                        if ((flag1 != 'H-1' && flag1 != 'H') && salesFlag == 'Y') {
                            if (stnFlag == 'Y') {
                                if($('#in_bank').combobox('getText')=='CIMB NIAGA' || $('#in_bank').combobox('getText')=='BANK CIMB NIAGA'){
                                      $.ajax({
                                        method: "POST",
                                        url: base_url + "InputBatchDenom/cekCIMBNIAGA/",
                                        data: {
                                            sales_date: $("#tglSales").datebox('getValue'),
                                            store_code: $("#storeCode").textbox('getValue'),
                                            stnFlag: stnFlag
            ...
            success: function(msg) {
                if (msg == 0) {
                    ...
                    if(recStatus == 'n'){
                        $.ajax({
                            method: "POST",
                            url: base_url+"InputBatchDenom/cekData/",
                            data: { 
                                store_code          : $("#storeCode").textbox('getValue'),
                                sales_date          : $("#tglSales").datebox('getValue'),
                                sales_flag          : salesFlag,
                                    ...
                                    if(checking){
                                        if($("#cashPenggantian").textbox('getValue') <= 0 && salesFlag=='Y'){
                                            ...
                                            /*if( kurang >= total ){
                                                ...
                                                $.ajax({
                                                    method: 'POST',
                                                    url: base_url+"InputBatchDenom/cek_trx_detail",
                                                    data:{
                                                        tambah  : parseInt($("#totalPenambah").textbox('getValue')),
                                                        kurang  : parseInt($("#totalPengurang").textbox('getValue')),
                                                    ...
                                                    success: function (msg) {
                                                        if (msg > 0) {
                                                            $.ajax({
                                                                method: "POST",
                                                                url: base_url+"InputBatchDenom/praInput",
                                                                data: { 
                                                                    statusxx            : recStatus,
                                                                    receiptID           : $('#CDC_REC_ID').val(),
                                                                    store_code          : storeID,
                                                                ...
                                                                success: function (message) {
                                                                    if ($("#savBatch").attr('batchid') != '') {
                                                                        $('#tblTrxReceipts').datagrid('reload', base_url+'InputBatchDenom/getPraInputReject/'+$("#savBatch").attr('batchid'));
                                                                    }else{
                                                                        $('#tblTrxReceipts').datagrid('reload', base_url+'InputBatchDenom/getPraInput');
                                                                    }
                                                                    $.messager.show({title: 'Success',msg: message});
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////          
                        ...
                        if($("#cashPenggantian").textbox('getValue') <= 0){
                            ...
                            if( kurang >= total ){
                                ...
                                $.ajax({
                                    method: "POST",
                                    url: base_url+"InputBatchDenom/praEdit",
                                    data: { 
                                        statusxx            : recStatus,
                                        receiptID           : $('#CDC_REC_ID').val(),
                                        store_code          : $('#storeCode').textbox('getValue'),
                ...
                $.messager.confirm('Confirm','Apakah anda yakin untuk Submit?',function(a){
                    if(a){
                        $.messager.confirm('Validate','Apakah ingin langsung dikirim ke VALIDATE ?',function(b){
                            ...
                            $.ajax({
                                method: "POST",
                                url: base_url+"InputBatchDenom/inputBatch",
                                data: { 
                                    receiptID   : row2,
                                    validate    : 1,
                                    adaGTU      : 0
                                ...
                                success: function (message) {
                                    $("#prog-trans").window('close');
                                    window.open(base_url+'InputBatchDenom/printBatch/'+message+'/P', "Report Batch Receipts", "width=1000,height=600,scrollbars=yes");
                                    $('#data_trx_kurset').datagrid('reload');
                                    $('#tblTrxReceipts').datagrid('reload', base_url+'InputBatchDenom/getPraInputShift');
                                    totalSetor();
...
function btnGenerateShift(){
    ...
    for(var x = 0;x < uniq.length;x++){
        ...
        $.ajax({
            method: 'POST',
            async: false,
            url:base_url+'InputBatchDenom/getTotalDataSelect',
            data:{
                rec_id: parseInt(rcp)
            },
            success: function(r){
                ...
                $.messager.confirm('Confirm','Apakah anda yakin untuk Submit?',function(a){
                    if(a){
                        $.ajax({
                            method: "POST",
                            async:false,
                            url: base_url+"InputBatchDenom/Pindah_data_shift",
                            data:{
                                receiptID : row
                            },
                            success:function(message){
                                $.messager.confirm('Validate','Apakah ingin langsung dikirim ke VALIDATE ?',function(b){
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (message) {
                                                $.ajax({
                                                    method: "POST",
                                                    url: base_url+"InputBatchDenom/Update_Receipt_Shift",
                                                    data: {
                                                        receiptID : row,
                                                        validate : 1
                                                    }
...
function btnPrint(){
    ...
    if(count >= 1){ 
        window.open(base_url+'InputBatchDenom/printReceipts/'+row, "Report Receipts", "width=1000,height=600,scrollbars=yes");
/*  
        $.ajax({
          method: "POST",
          url: base_url+"InputBatchDenom/printReceipts",
          data: { 
                    receiptID   : row,
                },
                        ...
                        $.messager.confirm('Validate','Apakah ingin langsung dikirim ke VALIDATE ?',function(b){
                            ...
                            $.ajax({
                                ...
                                success: function (message) {
                                    ...
                                    window.open(base_url+'InputBatchDenom/printBatch/'+message+'/P', "Report Batches", "width=1000,height=600,scrollbars=yes");
                                    $('#tblTrxReceipts').datagrid('reload', base_url+'InputBatchDenom/getPraInputShift');
                            ...
                            $.ajax({
                                ...
                                success: function (message) {
                                    ...
                                    window.open(base_url+'InputBatchDenom/printBatch/'+message+'/P', "Report Summary Collect", "width=1000,height=600,scrollbars=yes");
                                    $('#tblTrxReceipts').datagrid('reload', base_url+'InputBatchDenom/getPraInputShift');
                                    $('#GTU_sent').dialog('close');
                                    totalSetor();
                                    $.messager.show({title: 'Success',msg: 'Generate Batch Success'});
...
function btnSaveBatch() {
    $.ajax({
        method: "POST",
        url: base_url+'InputBatchDenom/cek_batch_type/'+$('#savBatch').attr('batchid'),
        success: function(group_count) {
            if (group_count > 1) {
                ...
                $.ajax({
                    method: "POST",
                    url: base_url+"InputBatchDenom/resubmit_batch/",
                    data:{
                        batch_id : $('#savBatch').attr('batchid')
                    },
